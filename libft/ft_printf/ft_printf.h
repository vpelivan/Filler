...
# define CHAR (s[*i] == 's' || s[*i] == 'c' || s[*i] == '%')
# define DIGITS (s[*i] == 'd' || s[*i] == 'i' || s[*i] == 'f' || s[*i] == 'u')
# define BASES (s[*i] == 'x' || s[*i] == 'X' || s[*i] == 'o' || s[*i] == 'p')
# define BONUS1 (s[*i] == 'r' || s[*i] == 'k' || s[*i] == 'g' || s[*i] == 'F')
# define BONUS2 (s[*i] == 'b')
# define NONPRC1 (str[i] == '\n' || str[i] == '\t' || str[i] == '\r')
# define NONPRC2 (str[i] == '\v' || str[i] == '\a' || str[i] == '\b')
# define NONPRC3 (str[i] == '\f')
# define RED "\x1b[31m"
...
void			create_list(const char *s, size_t *i, va_list ptr);
